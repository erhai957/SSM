...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />管理系统</h1>
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="<%=basePath%>PermissionController/list.do" target="right"><span class="icon-caret-right"></span>权限管理</a></li> 
  ...
  <ul>
    ...
    <li><a href="add.html" target="right"><span class="icon-caret-right"></span>收件箱</a></li>
